...
export function LikeWhatYouSeeBanner({ 
  ...
  if (state === 'minimized') {
    return (
      <button
        onClick={onExpand}
        className="fixed bottom-6 right-6 z-50 h-20 w-20 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 shadow-xl shadow-purple-500/30 flex items-center justify-center transition-all duration-300 hover:scale-110 animate-fade-in"
